  ...
  return (
   ...
   <Link to='/'><div className='text-sm md:text-2xl xl:text-3xl font-bold h-full mr-2 flex justify-center items-center'>🔥Database Handler</div></Link>
      <div className='flex justify-center items-center gap-10'>
        <div className='text-sm md:text-2xl xl:text-2xl font-bold xl:w-auto h-[10vh] flex justify-center items-center'>{`Greetings!! ${user.displayName}`}</div>
        <div className=' w-[80px] h-[45px] xl:w-[70px] xl:h-[70px] rounded-full flex justify-center items-center'>
          <img
            src={user?.photoURL}
            onError={(e) => {
              e.currentTarget.src = "https://img.daisyui.com/images/profile/demo/yellingwoman@192.webp";
            }}
